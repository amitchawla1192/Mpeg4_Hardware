...
void x264_mb_predict_mv( x264_t *h, int i_list, int idx, int i_width, int16_t mvp[2] )// H/W analyse.c, macroblock.c cabac.c, cavlc.c
{
...
void x264_mb_predict_mv_16x16( x264_t *h, int i_list, int i_ref, int16_t mvp[2] )// H/W in analyse.c
{
...
void x264_mb_predict_mv_pskip( x264_t *h, int16_t mv[2] )// H/W macroblock.c
{
