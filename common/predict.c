...
void x264_predict_16x16_dc_c( pixel *src )
{
 ...
 void x264_predict_16x16_dc_left_c( pixel *src )
{
    int dc = 0;
 ...
 void x264_predict_16x16_dc_top_c( pixel *src )
{
    int dc = 0;
 ...
 void x264_predict_16x16_dc_128_c( pixel *src )
{
 ...
 ****************************************************************************/
 ...
 void x264_predict_8x8c_dc_128_c( pixel *src )
{
    for( int y = 0; y < 8; y++ )
    {
 ...
 void x264_predict_8x8c_dc_left_c( pixel *src )
{
    int dc0 = 0, dc1 = 0;
 ...
 void x264_predict_8x8c_dc_top_c( pixel *src )
{
    int dc0 = 0, dc1 = 0;
...
//// Hardware in macroblock and analyse for complete 8x16
/****************************************************************************
 * 8x16 prediction for intra chroma block (4:2:2)
 ****************************************************************************/

 void x264_predict_8x16c_dc_128_c( pixel *src )
{
    for( int y = 0; y < 16; y++ )
    {
        MPIXEL_X4( src+0 ) = PIXEL_SPLAT_X4( 1 << (BIT_DEPTH-1) );
 ...
 void x264_predict_8x16c_dc_left_c( pixel *src )
{
    for( int i = 0; i < 4; i++ )
    {
        int dc = 0;
 ...
 void x264_predict_8x16c_dc_top_c( pixel *src )
{
    int dc0 = 0, dc1 = 0;
...
/////////////// Hardware in macroblock and analyse for complete 4x4 prediction
/****************************************************************************
...
#define PREDICT_4x4_DC(v)\
 ...
 void x264_predict_4x4_dc_128_c( pixel *src )
{
    PREDICT_4x4_DC( PIXEL_SPLAT_X4( 1 << (BIT_DEPTH-1) ) );
}
 void x264_predict_4x4_dc_left_c( pixel *src )
{
    pixel4 dc = PIXEL_SPLAT_X4( (SRC(-1,0) + SRC(-1,1) + SRC(-1,2) + SRC(-1,3) + 2) >> 2 );
    PREDICT_4x4_DC( dc );
}
 void x264_predict_4x4_dc_top_c( pixel *src )
{
...
#define PT(x) \
 ...
 void x264_predict_8x8_filter_c( pixel *src, pixel edge[36], int i_neighbor, int i_filters )// S/W and H/W
{
    /* edge[7..14] = l7..l0
     * edge[15] = lt
     * edge[16..31] = t0 .. t15
...
#define PREDICT_8x8_DC(v) \
 ...
 void x264_predict_8x8_dc_128_c( pixel *src, pixel edge[36]) // S/W and H/W
{
    PREDICT_8x8_DC( PIXEL_SPLAT_X4( 1 << (BIT_DEPTH-1) ) );
}
 void x264_predict_8x8_dc_left_c( pixel *src, pixel edge[36] )// S/W and H/W 
{
    PREDICT_8x8_LOAD_LEFT
    pixel4 dc = PIXEL_SPLAT_X4( (l0+l1+l2+l3+l4+l5+l6+l7+4) >> 3 );
    PREDICT_8x8_DC( dc );
}
 void x264_predict_8x8_dc_top_c( pixel *src, pixel edge[36] )//S/W and H/W
{
    PREDICT_8x8_LOAD_TOP
    pixel4 dc = PIXEL_SPLAT_X4( (t0+t1+t2+t3+t4+t5+t6+t7+4) >> 3 );
    PREDICT_8x8_DC( dc );
}
void x264_predict_8x8_dc_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_LEFT
    PREDICT_8x8_LOAD_TOP
...
void x264_predict_8x8_h_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_LEFT
...
void x264_predict_8x8_v_c( pixel *src, pixel edge[36] )
{
 ...
 void x264_predict_8x8_ddl_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_TOP
 ...
 void x264_predict_8x8_ddr_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_TOP
    PREDICT_8x8_LOAD_LEFT
 ...
 void x264_predict_8x8_vr_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_TOP
    PREDICT_8x8_LOAD_LEFT
    PREDICT_8x8_LOAD_TOPLEFT
 ...
 void x264_predict_8x8_hd_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_TOP
    PREDICT_8x8_LOAD_LEFT
    PREDICT_8x8_LOAD_TOPLEFT
 ...
 void x264_predict_8x8_vl_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_TOP
    PREDICT_8x8_LOAD_TOPRIGHT
    SRC(0,0)= F1(t0,t1);
 ...
 void x264_predict_8x8_hu_c( pixel *src, pixel edge[36] )// S/W and H/W
{
    PREDICT_8x8_LOAD_LEFT
 ...
 ****************************************************************************/
/*
void x264_predict_16x16_init( int cpu, x264_predict_t pf[7] )// Hardware in macroblock.c and analyse.c
{
...
void x264_predict_8x8c_init( int cpu, x264_predict_t pf[7] )// Software as well hardware in slicetype.c and analyse.c
{
...
void x264_predict_8x16c_init( int cpu, x264_predict_t pf[7] )// Hardware in macroblock.c and analyse.c as predict_chroma
{
...
void x264_predict_8x8_init( int cpu, x264_predict8x8_t pf[12], x264_predict_8x8_filter_t *predict_filter )// Software as well hardware in slicetype.c and analyse.c
{
...
void x264_predict_4x4_init( int cpu, x264_predict_t pf[12] )// Hardware in Macroblock.c and analyse.c
{
